 ...
 * 3. Адаптация под PLONK (нет плавающей точки)
 * 4. Общий пруф, где исключены повторения обязательств и тп
 * 5. А мб. свидетели зашиты в диапазоны?
 * 6. Проверить, действительно ли работает криптография? (у чатика, как проверить ту же перестановку и тп)
