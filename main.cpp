 ...
 * 2. Адаптация под PLONK (нет плавающей точки)
 * 3. А мб. свидетели зашиты в диапазоны? (типа [1, много])
 * 4. Проверить, действительно ли работает криптография? (у чатика, как проверить ту же перестановку и тп)
 * 5. Оптимизация: если таблица разбивается на полиномы степеней больше 3, то разбивать (но на кратное 3)!
